...
//     private bool $allowedTextContent = true;

//     public function __construct(TagName $tagName, bool $allowedTextContent = true) {
//         $this->tagName = $tagName;
//         $this->allowedTextContent = $allowedTextContent;
//     }
...
//     public function __construct() {
//         parent::__construct(tagName: TagName::STRING);
//     }
//     public function setTextContent(string $text): static {
//         $this->textContent = htmlspecialchars($text);
//         return $this;
//     }
...
//     public function __construct() {
//         parent::__construct(tagName: TagName::TABLE, allowedTextContent: false);
//     }
// }

// class TableHeaderElement extends BaseElement {
//     public function __construct() {
//         parent::__construct(tagName: TagName::THEAD, allowedTextContent: false);
//     }
// }

// class TableBodyElement extends BaseElement {
//     public function __construct() {
//         parent::__construct(tagName: TagName::TBODY, allowedTextContent: false);
//     }
// }

// class TableFooterElement extends BaseElement {
//     public function __construct() {
//         parent::__construct(tagName: TagName::TFOOT, allowedTextContent: false);
//     }
// }

// class TableRowElement extends BaseElement {
//     public function __construct() {
//         parent::__construct(tagName: TagName::TR, allowedTextContent: false);
//     }

// }

// class TableDataCellElement extends BaseElement {
//     public function __construct() {
//         parent::__construct(tagName: TagName::TD);
//     }
// }

// class TableHeaderCellElement extends BaseElement {
//     public function __construct() {
